...
- Name: app.spec.ts >> checklist 1-8 browser flows >> rich text toolbar applies heading and lists then persists
...
- main:
  - link "← All documents":
    - /url: /docs
  - textbox "Document title": Untitled document
  - paragraph: Owner Alice Sharma (alice@ajaia.dev) · you own this
  - button "Share"
  - paragraph: Saving…
  - button "Save now"
  - button "Bold"
  ...
  - button "Bullets"
  - button "Numbers"
  - paragraph: Editing Untitled document
  - heading "Persist me" [level=1]
  - paragraph
```
